...
namespace TipsTrade.HMRC.FraudPrevention.ConnectionMethods {
  /// <summary>Fraud prevention headers for a mobile application connecting through intermediary servers to HMRC.</summary>
  /// <remarks>
  /// See <see href="https://developer.service.hmrc.gov.uk/guides/fraud-prevention/connection-method/mobile-app-via-server/"/> for information
  ...
  /// </remarks>
  public class MobileAppViaServer :
    IFraudPrevention,
    IDeviceId,
    ILocalIps,
    IMultiFactor,
    ...
    IVendorVersion {
    /// <inheritdoc/>
    public ConnectionMethod ConnectionMethod => ConnectionMethod.MOBILE_APP_VIA_SERVER;
