...
namespace TipsTrade.HMRC.FraudPrevention.ConnectionMethods {
  /// <summary>Fraud prevention headers for a desktop application connecting through intermediary servers to HMRC.</summary>
  /// <remarks>
  /// See <see href="https://developer.service.hmrc.gov.uk/guides/fraud-prevention/connection-method/desktop-app-via-server/"/> for information
  ...
  /// </remarks>
  public class DesktopAppViaServer :
    IFraudPrevention,
    IDeviceId,
    ILocalIps,
    IMacAddresses,
    ...
    IVendorVersion {
    /// <inheritdoc/>
    public ConnectionMethod ConnectionMethod => ConnectionMethod.DESKTOP_APP_VIA_SERVER;
