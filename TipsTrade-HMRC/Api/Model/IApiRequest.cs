...
namespace TipsTrade.HMRC.Api.Model {
  ...
  internal interface IApiRequest {
    ...
    /// <summary>
    /// Populates the provided <see cref="RestRequest"/> with any required parameters, headers, and body content.
    /// Implementations should configure the request so it is ready to be executed by a REST client.
    /// </summary>
