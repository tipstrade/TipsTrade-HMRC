...
namespace TipsTrade.HMRC.Tests {
  public class FuelScaleChargeTests : TestBase {
    ...
    public void TestFuelScaleChargesLive() {
      ...
      resp = VatApi.GetFuelScaleChargeFromCO2Live(new DateTime(2023, 1, 1), VatPeriod.Annual, 0);
      ...
      resp = VatApi.GetFuelScaleChargeFromCO2Live(new DateTime(2023, 1, 1), VatPeriod.Quarter, 167);
      ...
      // Maximum CO2 monthly
      resp = VatApi.GetFuelScaleChargeFromCO2Live(new DateTime(2023, 1, 1), VatPeriod.Month, 400);
      ...
      // Maxium CO2 annually
      resp = VatApi.GetFuelScaleChargeFromCO2Live(new DateTime(2023, 1, 1), VatPeriod.Annual, 400);
